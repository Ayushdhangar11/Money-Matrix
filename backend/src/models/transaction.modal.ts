...
import { convertToCents, convertToDollarUnit } from "../utils/format_curr";
...
const transactionSchema = new Schema<TransactionDocument>({
    ...
    type: {
      type: String,
      enum: Object.values(TransactionTypeEnum), //enum is a Mongoose validator.It ensures that the value saved in MongoDB is only one of the specified values.
      required: true,
    },
    amount: {
      type: Number,
